        ...
        <form onSubmit={onSubmit}>
          <div className="dashboard-dialog-body">
            ...
            <div className="dashboard-form-card space-y-3">
              {accountType === "bank" ? (
                <>
                  <div className="dashboard-field-label">Sucursales</div>
            ...
            <div className="dashboard-form-card space-y-4">
              <div>
                <div className="dashboard-field-label">Icono o logo</div>
                <p className="dashboard-field-hint mt-1">
                  Opcional. Se mostrará en la lista y en el detalle de la cuenta.
                </p>
              </div>

              <div className="flex flex-col gap-4 rounded-[1rem] border border-dashed border-border/70 bg-muted/15 p-4 sm:flex-row sm:items-center">
                <div className="flex h-24 w-24 shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-border/70 bg-background shadow-sm">
                  {previewUrl ? (
                ...
                <div className="min-w-0 flex-1 space-y-3">
                  ...
                  <div className="dashboard-info-surface text-sm leading-6 text-muted-foreground">
